...
class PalettesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create palette" do
    assert_difference('Palette.count') do
      post palettes_url, params: { palette: { color_name: @palette.color_name, img: @palette.img } }, as: :json
    end
  ...
  test "should update palette" do
    patch palette_url(@palette), params: { palette: { color_name: @palette.color_name, img: @palette.img } }, as: :json
    assert_response 200
  end
